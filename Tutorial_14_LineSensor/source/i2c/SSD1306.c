...
void SSD1306_WriteCommand(uint8_t cmd) {
	i2cWriteCmdData(SSD1306_I2C_ADDR, SSD1306_CMD_REG, &cmd, 1);
	//GI2C1_WriteByteAddress8(SSD1306_I2C_ADDR, SSD1306_CMD_REG, cmd);
}

void SSD1306_WriteData(uint8_t data) {
	i2cWriteCmdData(SSD1306_I2C_ADDR, SSD1306_DATA_REG, &data, 1);
	//GI2C1_WriteByteAddress8(SSD1306_I2C_ADDR, SSD1306_DATA_REG, data);
}

void SSD1306_Init(void) {
	// check display connected
	if (i2cTest(SSD1306_I2C_ADDR) != EC_SUCCESS) {
		return;
	}
