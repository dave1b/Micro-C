...
const adc16_hardware_average_mode_t ADC1_hardwareAverageMode = kADC16_HardwareAverageCount32;
...
void FTM0_init(void) {
  ...
  FTM_SetupInputCapture(FTM0_PERIPHERAL, kFTM_Chnl_5, kFTM_RiseAndFallEdge, 0);
  FTM_SetTimerPeriod(FTM0_PERIPHERAL, ((FTM0_CLOCK_SOURCE/ (1U << (FTM0_PERIPHERAL->SC & FTM_SC_PS_MASK))) / 1) + 1);
  FTM_EnableInterrupts(FTM0_PERIPHERAL, kFTM_Chnl5InterruptEnable);
...
void FTM3_init(void) {
  ...
  FTM_SetTimerPeriod(FTM3_PERIPHERAL, ((FTM3_CLOCK_SOURCE/ (1U << (FTM3_PERIPHERAL->SC & FTM_SC_PS_MASK))) / 10000) + 1);
